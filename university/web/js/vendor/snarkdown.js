// Vendored from snarkdown
// https://github.com/developit/snarkdown
// Copyright (c) 2017 Jason Miller
// Licensed under the MIT License; see snarkdown.LICENSE.txt in this directory.
//
// Adapted to a classic (non-module) script: exposes `window.snarkdown`.
(function () {
  var TAGS = {
    '': ['<em>', '</em>'],
    _: ['<strong>', '</strong>'],
